...
| [Upstream Sokol cube](examples/core33-sokol-cube/README.md) | Adapted existing 3D sample: rotation, depth and culling | Host checks pass; native allocation failure under investigation |
