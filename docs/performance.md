...
## Submission and CPU preparation improvements

See [native submission and preparation](native-submission-performance.md) for
the implementation, validation coverage and remaining qualification limits.
