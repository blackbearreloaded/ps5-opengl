...
ifeq ($(PS5_DRAW_GPU_TIMESTAMPS),1)
PS5_OPENGL_RUNTIME_DEFINES += -DPS5_DRAW_GPU_TIMESTAMPS=1
endif
...
ifeq ($(PS5_RUNTIME_QUIET),1)
PS5_OPENGL_RUNTIME_DEFINES += -DPS5_RUNTIME_QUIET=1
endif

ifeq ($(PS5_ASYNC_NATIVE_PREP),1)
PS5_OPENGL_RUNTIME_DEFINES += -DPS5_ASYNC_NATIVE_PREP=1
endif
